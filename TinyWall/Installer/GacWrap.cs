...
namespace System.Gac
{
    ...
    {
        internal static bool IsValidGuidScheme(Guid guid)
        {
        ...
        internal readonly static Guid OpaqueGuid = new Guid("2ec93463-b0c3-45e1-8364-327e96aea856");
    ...
    {
        internal static void InstallAssembly(String assemblyPath, InstallReference reference, AssemblyCommitFlags flags)
        {
            if (reference != null)
            {
        ...
        internal static void UninstallAssembly(String assemblyName, InstallReference reference, out AssemblyCacheUninstallDisposition disp)
        {
    ...
    internal class AssemblyCacheEnum
    {
        ...
        internal String GetNextAssembly()
        {
            int hr = 0;
            IAssemblyName fusionName = null;
    ...
    {
        internal AssemblyCacheInstallReferenceEnum(String assemblyName)
        {
            IAssemblyName fusionName = null;
        ...
        internal InstallReference GetNextReference()
        {
